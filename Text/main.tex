...
\begin{enumerate}
	...
	\item \textbf{Блок}. Атрибуты: тема, видимость, следующий блок;
	\item \textbf{Лекция}. Атрибуты: название, содержание, продолжительность, видимость, следующая лекция, следующий проверочный материал;
	\item \textbf{Проверочный материал}. Атрибуты: название, максимальный балл, продолжительность, видимость, следующая лекция, следующий проверочный материал;
...
\begin{adjustbox}{width=\linewidth}
	\begin{tabular}{|l|l|c|l|}
		...
		Следующий блок  & B\_NEXT\_ID   &    N(4)    & внешний ключ (к Block)              \\ \hline
	\end{tabular}
\end{adjustbox}
\end{table}
...
Для определения последовательности блоков было добавлено поле с внешним ключом на эту же таблицу.
...
L\_LECTURE\_NEXT\_ID IS NULL OR L\_TESTMETERIAL\_NEXT\_ID IS NULL
