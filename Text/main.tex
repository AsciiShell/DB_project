...
\begin{tabular}{|c|c|c|c|c|}
	\hline
	    ...
	    Пользователь     &     SIUD      &      SI       &     S      &         \\ \hline
	        Курс         &     SIUD      &      SU       &     S      &    S    \\ \hline
	     Категория       &     SIUD      &       S       &            &         \\ \hline
	  Категория курса    &       S       &     SIUD      &     S      &    S    \\ \hline
	        Блок         &       S       &     SIUD      &     S      &    S    \\ \hline
	       Лекция        &       S       &     SIUD      &     S      &    S    \\ \hline
	Проверочный материал &       S       &     SIUD      &     S      &    S    \\ \hline
	      Попытка        &       S       &      SUD      &     SU     &   SI    \\ \hline
	      Участие        &     SIUD      &     SIUD      &            &         \\ \hline
	 Прочитанные лекции  &       S       &       S       &            &   SID   \\ \hline
\end{tabular}
\end{table}
%\newpage 
