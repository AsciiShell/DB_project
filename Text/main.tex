...
\begin{adjustbox}{width=\linewidth}
	\begin{tabular}{|l|l|c|l|}
		...
		Предыдущий блок  & B\_LAST\_ID   &    N(4)    & внешний ключ (к Block)              \\ \hline
	\end{tabular}
\end{adjustbox}
\end{table}
...
\begin{adjustbox}{width=\linewidth}
	\begin{tabular}{|l|l|c|l|}
		...
		Предыдущая лекция    & L\_LAST\_ID   &    N(4)    & внешний ключ    (к Lecture)         \\ \hline
	\end{tabular}
\end{adjustbox}
\end{table}
...
\begin{adjustbox}{width=\linewidth}
	\begin{tabular}{|l|l|c|l|}
		...
		Лекция                       & T\_EXTEND     &    N(4)    & внешний ключ  (к Lecture)      \\ \hline
	\end{tabular}
\end{adjustbox}
\end{table}
